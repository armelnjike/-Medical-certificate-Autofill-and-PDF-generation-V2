            ...
            <div class="section-content">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        Backdate ?
                        <label for="backdate">
                            Click the checkbox you want to backdate
                            <input id="backdate" type="checkbox" name="backdate" value="yes">
                        </label>
                        <br/>

                        <label for="newdate" >
                            <input id="newdate" type="date" name="newdate" placeholder="Enter the new date !" style="display: none">
                        </label><br/>
