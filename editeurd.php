...
<div class="container">
    ...
    <form id="documentForm">
        ...
        <div class="button-group">
            <a href="index.html"><button type="submit">Return Home</button></a>
            ...
            <div class="section-content">
                <div class="form-grid">
                    <div class="form-group">
                        <label for="image1" class="required">Signature Ici</label>
                        <div class="upload-container" onclick="document.getElementById('image1').click()">
                            ...
                            <div class="upload-placeholder" id="placeholder1" style="<?= $signUrl ? 'display:none' : '' ?>">
                                ...
                                <div class="upload-subtext">ou glissez-déposez votre fichier ici</div>
...
<script>
    ...
    ClassicEditor
        ...
        .then(editor => {
            ...
            // 2. Charger le contenu par défaut
            fetch('mestemplates/montemplate.html')
                ...
                .then(data => {
                    editorInstance.setData(data); // Injecte le contenu dans CKEditor
                })
                .catch(error => {
